...
epicsEnvSet("PCI_SLOT", "$(PCI_BUS_NUM):09.0")

epicsEnvSet("SYS", "HZB-V20:TS")
epicsEnvSet("DEVICE", "EVR-03")
epicsEnvSet("EVR", "$(DEVICE)")
epicsEnvSet("CHIC_SYS", "HZB-V20:")
epicsEnvSet("CHOP_DRV", "Chop-Drv-03")
...
epicsEnvSet("NCG_DRV", "Chop-Drv-03tmp:")
##################################################
...
dbLoadRecords("/epics/iocs/cmds/hzb-v20-evr-03-cmd/evr3alias.db")
...
#dbpf $(SYS)-$(DEVICE):OutFPUV00-Src-SP 61 #Not universal I/O, no need to specify
...
#dbpf $(SYS)-$(DEVICE):OutFPUV01-Src-SP 61 #Not universal I/O, no need to specify
